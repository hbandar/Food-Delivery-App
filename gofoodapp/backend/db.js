...
const mongoURI = "mongodb://localhost:27017/gofoodDB";
...
const mongoDB = () => {
  ...
  const itemsModel = mongoose.model("FoodItem", itemSchema);

  // fetching data from Fooditems collection in db
  itemsModel.find({}).then(function (data) {
    global.food_items = data;
  });
  categoryModel.find({}).then(function(data){
    global.food_category = data;
  })
//   categoryModel.updateOne({name:"starter"},{name:"Starter"}).then();
...
module.exports = mongoDB;
 ...
 // update docs
  ...
  //     itemsModel.updateOne({name: "Chicken Cheese Pizza"},{options: [{
  //         regular: "120",
  //         medium: "230",
  //         large: "350"
  //       }]
...
// itemsModel.insertMany(items).then(()=>{
//     console.log("inserted");
// });
// const cat1 = new categoryModel({name:"biryani/Rice"});
// const cat2 = new categoryModel({name:"Pizza"});
// const cat3 = new categoryModel({name:"starter"});

// categoryModel.insertMany([cat1,cat2,cat3]).then(function(){
//         console.log("inserted");
// itemsModel.find({}).then((data)=>{
//     console.log(data);
// });
